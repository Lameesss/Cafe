...
export default function Navbar() {
  ...
  return (
    <nav 
      ...
      style={{
        backgroundColor: showBg ? 'var(--bg-color)' : 'transparent',
        borderBottom: showBg ? '1px solid var(--heading-color)' : '1px solid transparent',
    ...
    >
        ...
        <div className="flex justify-between items-center h-16 lg:justify-between">
          ...
          >
            <motion.span
              ...
              style={{ backgroundColor: showBg ? 'var(--heading-color)' : 'var(--text-color)' }}
            />
            <motion.span
          ...
          <div className="hidden lg:flex items-center space-x-10 absolute left-1/2 transform -translate-x-1/2 order-2">
            {navItems.map((item) => (
              <Link
                key={item.name}
                href={item.href}
                className="transition-all duration-300 text-sm font-medium uppercase tracking-wider relative after:content-[''] after:absolute after:w-0 after:h-[2px] after:bottom-[-4px] after:left-0 after:transition-all after:duration-300 hover:after:w-full"
                style={{ 
                  color: showBg ? 'var(--heading-color)' : 'var(--text-color)',
                }}
                onMouseEnter={(e) => {
                  e.target.style.opacity = '0.7';
                  e.target.querySelector('::after') && (e.target.querySelector('::after').style.backgroundColor = 'var(--heading-color)');
                }}
                onMouseLeave={(e) => {
          ...
          <div className="flex items-center space-x-4 lg:space-x-6 order-3">
            ...
            <button
              ...
              style={{ color: showBg ? 'var(--heading-color)' : 'var(--text-color)' }}
      ...
      <motion.div
        ...
        style={{ backgroundColor: 'var(--bg-color)', borderColor: 'var(--heading-color)' }}
      >
          ...
          <div className="flex flex-col items-start space-y-6">
            {navItems.map((item) => (
              <Link
                ...
                className="block transition-colors duration-300 text-2xl font-bold uppercase tracking-wider"
