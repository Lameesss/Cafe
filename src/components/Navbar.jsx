            ...
            >
              <Link href="/" className="flex items-center">
                <motion.div
                  ...
                  className="relative h-14 sm:h-16 lg:h-20 w-auto pt-2 sm:pt-2 lg:pt-3"
                >
                  <Image
                    src="/images/logo.png"
            ...
            >
              ...
              <div className="hidden lg:block">
                <Link
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.target.style.background = 'linear-gradient(135deg, #d4a574 0%, #edb98a 30%, #d4a574 70%, #edb98a 100%)';
                  }}
                  onMouseLeave={(e) => {
                    e.target.style.transform = 'translateY(0) scale(1)';
                    e.target.style.boxShadow = '0 4px 15px rgba(0, 0, 0, 0.2)';
                    e.target.style.background = 'linear-gradient(135deg, #edb98a 0%, #d4a574 30%, #c49660 70%, #edb98a 100%)';
                  }}
                >
                  {/* Arabic Text */}
              ...
              >
                ...
                <motion.div
                  ...
                  style={{ background: 'linear-gradient(135deg, #edb98a 0%, #d4a574 30%, #c49660 70%, #edb98a 100%)' }}
                />
                <motion.div
        ...
        {isOpen && (
          ...
          >
            ...
            <div 
              className="h-px"
              style={{
                background: 'linear-gradient(90deg, transparent 0%, rgba(237, 185, 138, 0.8) 20%, rgba(212, 165, 116, 0.8) 50%, rgba(237, 185, 138, 0.8) 80%, transparent 100%)'
              }}
            />
